...
photo=PhotoImage(file="C:/users/shiva kumar/Pictures/age.png")
...
Button(text="Calculator Age",font=20,bg="black",fg="white",width=15,height=2,command=calculateAge).place(x=300,y=450)
